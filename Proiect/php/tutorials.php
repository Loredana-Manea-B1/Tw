...
$result = mysqli_query($con, "SELECT * FROM coursesORDER BY idCourse");
 ?>
        ...
        <div class="main-box">
            <?php
                ...
                while ($record = mysqli_fetch_assoc($result))
                 ...
                 echo '<a href="../php/watchTutorial.php?tutorial='.$record['idTutorial'].'"><div class="box box-grey">'.
